...
static unsigned int CK[SM4_ROUND] = { 0x00070e15, 0x1c232a31, 0x383f464d, 0x545b6269, 0x70777e85, 0x8c939aa1,
...
void SMS4_CBC_Encryption(unsigned char plaintext[16], unsigned char key[16], unsigned char iv[16],
...
void SMS4_CBC_Decryption(unsigned char ciphertext[16], unsigned char key[16], unsigned char iv[16],
...
void SMS4_CBC_EncryptionEx(unsigned char plaintext[16], unsigned int key[32], unsigned char iv[16],
                           unsigned char ciphertext[16])
{
    unsigned char plaintextNew[16];
    int           i = 0;
...
void SMS4_CBC_DecryptionEx(unsigned char ciphertext[16], unsigned int key[32], unsigned char iv[16],
                           unsigned char plaintext[16])
{
    unsigned char plaintextTemp[16];
    int           i = 0;
 ...
 *
 */
int SM4_ECB_Encrypt(unsigned char *pKey, unsigned int KeyLen, unsigned char *pInData, unsigned int inDataLen,
 ...
 *
 */
int SM4_ECB_Decrypt(unsigned char *pKey, unsigned int KeyLen, unsigned char *pInData, unsigned int inDataLen,
                    unsigned char *pOutData, unsigned int *pOutDataLen)
{
    int i = 0;
    // int rv = 0;
 ...
 *
 */
int SM4_CBC_Encrypt(unsigned char *pKey, unsigned int KeyLen, unsigned char *pIV, unsigned int ivLen,
                    unsigned char *pInData, unsigned int inDataLen, unsigned char *pOutData, unsigned int *pOutDataLen)
{
    int i = 0;
    // int rv = 0;
    int            loop = 0;
 ...
 *
 */
int SM4_CBC_Decrypt(unsigned char *pKey, unsigned int KeyLen, unsigned char *pIV, unsigned int ivLen,
                    unsigned char *pInData, unsigned int inDataLen, unsigned char *pOutData, unsigned int *pOutDataLen)
{
    int i = 0;
    // int rv = 0;
