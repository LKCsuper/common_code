...
unsigned char radom[]    = { 0x6C, 0xB2, 0x8D, 0x99, 0x38, 0x5C, 0x17, 0x5C, 0x94, 0xF9, 0x4E,
                             0x93, 0x48, 0x17, 0x66, 0x3F, 0xC1, 0x76, 0xD9, 0x25, 0xDD, 0x72,
                             0xB7, 0x27, 0x26, 0x0D, 0xBA, 0xAE, 0x1F, 0xB2, 0xF9, 0x6F };
unsigned char radom1[]   = { 0x4C, 0x62, 0xEE, 0xFD, 0x6E, 0xCF, 0xC2, 0xB9, 0x5B, 0x92, 0xFD,
                             0x6C, 0x3D, 0x95, 0x75, 0x14, 0x8A, 0xFA, 0x17, 0x42, 0x55, 0x46,
                             0xD4, 0x90, 0x18, 0xE5, 0x38, 0x8D, 0x49, 0xDD, 0x7B, 0x4F };
unsigned char randkey[]  = { 0x83, 0xA2, 0xC9, 0xC8, 0xB9, 0x6E, 0x5A, 0xF7, 0x0B, 0xD4, 0x80,
                             0xB4, 0x72, 0x40, 0x9A, 0x9A, 0x32, 0x72, 0x57, 0xF1, 0xEB, 0xB7,
                             0x3F, 0x5B, 0x07, 0x33, 0x54, 0xB2, 0x48, 0x66, 0x85, 0x63 };
unsigned char randkeyb[] = { 0x33, 0xFE, 0x21, 0x94, 0x03, 0x42, 0x16, 0x1C, 0x55, 0x61, 0x9C,
                             0x4A, 0x0C, 0x06, 0x02, 0x93, 0xD5, 0x43, 0xC8, 0x0A, 0xF1, 0x97,
                             0x48, 0xCE, 0x17, 0x6D, 0x83, 0x47, 0x7D, 0xE7, 0x1C, 0x80 };
...
static unsigned char sm2_par_dig[128] = {
    ,
};
...
unsigned char sm2_par_dig[128] = {
    ...
    0xFF, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFC, 0x28, 0xE9, 0xFA, 0x9E, 0x9D, 0x9F,
    0x5E, 0x34, 0x4D, 0x5A, 0x9E, 0x4B, 0xCF, 0x65, 0x09, 0xA7, 0xF3, 0x97, 0x89, 0xF5, 0x15, 0xAB, 0x8F, 0x92, 0xDD,
    0xBC, 0xBD, 0x41, 0x4D, 0x94, 0x0E, 0x93, 0x32, 0xC4, 0xAE, 0x2C, 0x1F, 0x19, 0x81, 0x19, 0x5F, 0x99, 0x04, 0x46,
    0x6A, 0x39, 0xC9, 0x94, 0x8F, 0xE3, 0x0B, 0xBF, 0xF2, 0x66, 0x0B, 0xE1, 0x71, 0x5A, 0x45, 0x89, 0x33, 0x4C, 0x74,
    0xC7, 0xBC, 0x37, 0x36, 0xA2, 0xF4, 0xF6, 0x77, 0x9C, 0x59, 0xBD, 0xCE, 0xE3, 0x6B, 0x69, 0x21, 0x53, 0xD0, 0xA9,
    0x87, 0x7C, 0xC6, 0x2A, 0x47, 0x40, 0x02, 0xDF, 0x32, 0xE5, 0x21, 0x39, 0xF0, 0xA0,
};
...
unsigned char *sm3_e(unsigned char *userid, int userid_len, unsigned char *xa, int xa_len, unsigned char *ya,
                     int ya_len, unsigned char *msg, int msg_len, unsigned char *e)
{
    /*
...
int sm3_z(unsigned char *userid, int userid_len, unsigned char *xa, int xa_len, unsigned char *ya, int ya_len,
          unsigned char *z)
{
    /*
    功能：根据用户ID及公钥，求Z值
...
int sm2_sign(unsigned char *hash, int hashlen, unsigned char *privkey, int privkeylen, unsigned char *cr, int *rlen,
...
int sm2_encrypt(unsigned char *msg, int msglen, unsigned char *wx, int wxlen, unsigned char *wy, int wylen,
...
int sm2_keyagreement_a(unsigned char *kxa, int kxalen, unsigned char *kya, int kyalen, unsigned char *xa, int xalen,
                       unsigned char *ya, int yalen, unsigned char *private_a, int private_a_len, unsigned char *xb,
                       int xblen, unsigned char *yb, int yblen, unsigned char *ida, int idalen, unsigned char *idb,
                       int idblen, unsigned char *kxb, int kxblen, unsigned char *kyb, int kyblen,
                       unsigned char *private_a_tmp, int private_a_tmp_len, unsigned int keylen, unsigned char *keybuf,
...
int sm2_keyagreement_b(unsigned char *kxb, int kxblen, unsigned char *kyb, int kyblen, unsigned char *xb, int xblen,
                       unsigned char *yb, int yblen, unsigned char *private_b, int private_b_len, unsigned char *xa,
                       int xalen, unsigned char *ya, int yalen, unsigned char *idb, int idblen, unsigned char *ida,
                       int idalen, unsigned char *kxa, int kxalen, unsigned char *kya, int kyalen,
                       unsigned char *private_b_tmp, int private_b_tmp_len, unsigned int keylen, unsigned char *keybuf,
                       unsigned char *s2, unsigned char *sb)
{
    /*
...
int sm2_check_point(CMpi *x, CMpi *y)
{
    ...
    if (CMpi_IsNegative(x) || CMpi_IsNegative(y) || !CMpi_LargerThan_abs(&g_p, x) || !CMpi_LargerThan_abs(&g_p, y))
        return 0;
...
void sm2_keyagreement_a1_3(unsigned char *kx1, int *kx1len, unsigned char *ky1, int *ky1len, unsigned char *ra,
                           int *ralen)
{
    struct FPECC *cfig = &Ecc256;
    big k, x1, y1;
...
int sm2_keyagreement_a4_10(unsigned char *kx1, int kx1len, unsigned char *ky1, int ky1len, unsigned char *pax,
                           int paxlen, unsigned char *pay, int paylen, unsigned char *private_a, int private_a_len,
                           unsigned char *pbx, int pbxlen, unsigned char *pby, int pbylen, unsigned char *ida,
                           int idalen, unsigned char *idb, int idblen, unsigned char *kx2, int kx2len,
                           unsigned char *ky2, int ky2len, unsigned char *ra, int ralen, unsigned int kalen,
...
int sm2_keyagreement_b1_9(unsigned char *kx1, int kx1len, unsigned char *ky1, int ky1len, unsigned char *pax,
                          int paxlen, unsigned char *pay, int paylen, unsigned char *private_b, int private_b_len,
                          unsigned char *pbx, int pbxlen, unsigned char *pby, int pbylen, unsigned char *ida,
                          int idalen, unsigned char *idb, int idblen, unsigned int kblen, unsigned char *kbbuf,
                          unsigned char *kx2, int *kx2len, unsigned char *ky2, int *ky2len, unsigned char *xv,
                          int *xvlen, unsigned char *yv, int *yvlen, unsigned char *sb)
{
    struct FPECC *cfig = &Ecc256;
