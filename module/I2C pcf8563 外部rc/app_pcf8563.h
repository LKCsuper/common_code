...
//
#ifndef __APP_PCF8563_H__
#define __APP_PCF8563_H__
#ifdef __cplusplus
extern "C" {
#endif
/* Includes ------------------------------------------------------------------*/
...
void PCF8563_CalculateDateTime(rtc_calendar_t *DateTime); // Use in DMA Complete Receive interrupt
#else
void PCF8563_GetDateTime(rtc_calendar_t *DateTime); // Use in blocking/interrupt mode in PCF8563_INT EXTI handler
#endif
void PCF8563_SetDateTime(rtc_calendar_t *DateTime);
void PCF8563_Init(I2C_TYPE *i2c);
void ReadPCF8563Time(I2C_SOFT_S *i2c);
void ReadPCF8563Second(I2C_SOFT_S *i2c);
#ifdef __cplusplus
}
#endif
#endif
